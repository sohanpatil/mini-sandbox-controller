...
import (
	...
	"example.com/mini-sandbox-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a7c0e595.example.com",
	...
	if err := (&controller.SandboxWarmPoolReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "SandboxWarmPool")
		os.Exit(1)
	}
